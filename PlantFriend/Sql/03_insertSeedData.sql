...
insert into Plant (Id, [Name], Light, Water, WaterFrequency, Temperature, Nutrients, NutrientsFrequency, [Description], CareNeeds, ImageUrl)
	values
		('bce4630e-3810-4cf1-a136-252f76ed70d1', '', '', '', '', '', 54, '', '', '', '', '')
...
insert into [Log] (Id, UserPlantId, DateCreated, EntryNumber, [Entry], EntryDate)
	values
		('b1a01661-4331-ec11-8172-0800275f12c6', 'P6NWPzbF3VQVhf4lVNMFQgiZPRe2', 1, 'Matthew', 'Gonzales', 'gonzalesmattg@gmail.com', cast('2021-10-19' as datetime), '0e628817-e344-4335-9933-4c827d5ec2ad'),
